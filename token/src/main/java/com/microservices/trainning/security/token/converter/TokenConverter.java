package com.microservices.trainning.security.token.converter;
...
public class TokenConverter {
    ...
    public String decryptToken (String encryptedToken){
        ...
        DirectDecrypter directDecrypter = new DirectDecrypter(jwtConfiguration.getPrivateBy().getBytes());
