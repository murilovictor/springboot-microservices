package com.microservices.trainning.security.token.creator;
...
public class TokenCreator {
    ...
    private JWTClaimsSet createJWTClaimSet(Authentication auth, ApplicationUser applicationUser) {
        ...
        return new JWTClaimsSet.Builder()
                ...
                .claim("authorities", auth.getAuthorities()
                        ...
                        .collect(toList()))
                .issuer("http://microservices.trainning")
                .issueTime(new Date())
    ...
    public String encryptToken(SignedJWT signedJWT) throws JOSEException {
        ...
        DirectEncrypter directEncrypter = new DirectEncrypter(jwtConfiguration.getPrivateBy().getBytes());

        JWEObject jweObject = new JWEObject(new JWEHeader.Builder(JWEAlgorithm.DIR, A128CBC_HS256)
                .contentType("JWT")
